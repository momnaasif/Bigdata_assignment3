...
def pcy_algorithm(transactions):
    ...
    print("Candidate Pairs with Support Threshold:", candidate_pairs)

    # Insert data into MongoDB
    db = connect_to_mongodb()
    collection = db['processed_data']
    data = {"frequent_items": list(frequent_items), "candidate_pairs": list(candidate_pairs)}
...
def consume_data():
    ...
    try:
        for message in consumer:
            print("Message received:", message.value)  # Debug output
            item = message.value
